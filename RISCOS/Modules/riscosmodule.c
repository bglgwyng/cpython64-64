...
riscos_stat(PyObject *self, PyObject *args)
{
    ...
    PyStructSequence_SET_ITEM(v, 0,
                              PyInt_FromLong((REALLYLONG) mode)); /*st_mode*/
    PyStructSequence_SET_ITEM(v, 1, PyInt_FromLong((REALLYLONG) 0)); /*st_ino*/
    PyStructSequence_SET_ITEM(v, 2, PyInt_FromLong((REALLYLONG) 0)); /*st_dev*/
    PyStructSequence_SET_ITEM(v, 3, PyInt_FromLong((REALLYLONG) 0)); /*st_nlink*/
    PyStructSequence_SET_ITEM(v, 4, PyInt_FromLong((REALLYLONG) 0)); /*st_uid*/
    PyStructSequence_SET_ITEM(v, 5, PyInt_FromLong((REALLYLONG) 0)); /*st_gid*/
    PyStructSequence_SET_ITEM(v, 6,
                              PyInt_FromLong((REALLYLONG) len)); /*st_size*/
    PyStructSequence_SET_ITEM(v, 7, PyInt_FromLong((REALLYLONG) t)); /*st_atime*/
    PyStructSequence_SET_ITEM(v, 8, PyInt_FromLong((REALLYLONG) t)); /*st_mtime*/
    PyStructSequence_SET_ITEM(v, 9, PyInt_FromLong((REALLYLONG) t)); /*st_ctime*/
    PyStructSequence_SET_ITEM(v, 10,
                              PyInt_FromLong((REALLYLONG) ft)); /*file type*/
    PyStructSequence_SET_ITEM(v, 11,
                              PyInt_FromLong((REALLYLONG) at)); /*attributes*/
    PyStructSequence_SET_ITEM(v, 12,
                              PyInt_FromLong((REALLYLONG) ob)); /*object type*/
